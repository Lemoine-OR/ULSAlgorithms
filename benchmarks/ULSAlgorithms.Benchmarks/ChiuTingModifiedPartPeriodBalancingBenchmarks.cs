...
[MemoryDiagnoser]
public class ChiuTingModifiedPartPeriodBalancingBenchmarks
{
    ...
    [Benchmark]
    public UlsSolveResult ModifiedPartPeriodBalancing() =>
        new ChiuTingModifiedPartPeriodBalancingSolver().Solve(_problem);
}
